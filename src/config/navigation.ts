...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Users, labelKey: "Learner Management", path: "/students", roles: ["admin", "teacher", "head_teacher", "deputy_head_teacher", "dos", "center_director", "director", "accountant", "nurse", "office_manager", "bursar", "staff"] },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: BookOpen, labelKey: "Official Documents", path: "/office/documents", roles: ["admin", "office_manager", "head_teacher"] },
      { icon: Bell, labelKey: "Comms & Circulars", path: "/office/comms", roles: ["admin", "office_manager", "head_teacher"] },
